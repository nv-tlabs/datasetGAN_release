...
*Download pretrained checkpoint from [Stylegan](https://github.com/NVlabs/stylegan) and put checkpoints in the folder of **./datasetGAN/dataset_release/stylegan_pretrain***. Please be aware that the any code dependency and checkpoint related to Stylegan, the license is under the [Creative Commons BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) license by NVIDIA Corporation.  
